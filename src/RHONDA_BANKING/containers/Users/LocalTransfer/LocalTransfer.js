...
import UserAccount from '../AccountDetails/UsersAccount/UserAccount';
...
const LocalTransfer = (props) => {
    ...
    return <React.Fragment>
            <div>
                <div onClick={() => props.history.goBack()} style={{margin: "3em 3px"}}><BiArrowBack style={{fontSize: "2em",margin:"20px 0px"}}/></div>
                <div>AMOUNT</div>
